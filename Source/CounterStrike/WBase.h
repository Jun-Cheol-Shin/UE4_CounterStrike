...
public:
	...
	//UPROPERTY(EditAnywhere)
	//	ECreatWeaponNum CreateWeaponNumber;
	...
	UPROPERTY(EditAnywhere)
		class USkeletalMeshComponent* TPSWeaponComponent;
	...
	AFPSCharacter* GetOwningPlayer() { return Player; }
	void SetOwningPlayer(AFPSCharacter* Character) { Player = Character; }
	...
	bool GetPossiblePickWeapon();
	void SetPossiblePickWeapon(bool value) { bPossiblePick = value; }
